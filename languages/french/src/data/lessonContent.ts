...
export const lessonsDataMap: Record<string, LessonItem[]> = {
  ...
  '1-2': [
    { id: 1, type: 'match', question: 'صل كل كلمة بالحرف الذي تبدأ به', pairs: [ { left: 'Abeille 🐝', right: 'A', id: 1 }, { left: 'Baleine 🐋', right: 'B', id: 2 }, { left: 'Chat 🐈', right: 'C', id: 3 }, { left: 'Dauphin 🐬', right: 'D', id: 4 } ] },
    { id: 2, type: 'match', question: 'صل كل كلمة بالحرف الذي تبدأ به', pairs: [ { left: 'Éléphant 🐘', right: 'E', id: 1 }, { left: 'Fourmi 🐜', right: 'F', id: 2 }, { left: 'Girafe 🦒', right: 'G', id: 3 }, { left: 'Hibou 🦉', right: 'H', id: 4 } ] },
    { id: 3, type: 'match', question: 'صل الحيوانات بأسمائها', pairs: [ { left: 'Iguane 🦎', right: 'إيغوانا', id: 1 }, { left: 'Jaguar 🐆', right: 'جاكوار', id: 2 }, { left: 'Chat 🐈', right: 'قطة', id: 3 }, { left: 'Lion 🦁', right: 'أسد', id: 4 } ] },
  ],
  '1-3': [
