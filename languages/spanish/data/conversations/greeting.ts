...
export const greeting: ConversationScenario = {
    ...
    quiz: [
      { type: 'multiple_choice', spanish: '¿De dónde es Juan?', arabic: 'من أين خوان؟', options: [ { text: 'إسبانيا', correct: false }, { text: 'العاصمة المكسيكية', correct: true }, { text: 'مدريد', correct: false } ] },
      { type: 'listening', spanish: 'Soy estudiante de medicina', arabic: 'أنا طالبة طب', options: [ { text: 'أنا طالبة طب', correct: true }, { text: 'أنا معلم اسباني', correct: false }, { text: 'عمري ٢٥ عام', correct: false } ] },
      { type: 'true_false', spanish: 'María es profesora.', arabic: 'ماريا هي المعلمة', isTrue: false, correctArabic: 'طالبة طب' }
    ]
};
