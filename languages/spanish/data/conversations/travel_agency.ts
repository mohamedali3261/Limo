...
export const travel_agency: ConversationScenario = {
    ...
    quiz: [
        {
            question: "¿A dónde quiere ir el cliente?",
            options: ["Bali", "Tailandia", "Hawái"],
            correctAnswer: "Bali"
        },
        {
            question: "¿Qué tipo de alojamiento prefiere?",
            options: ["Hotel de lujo", "Villas privadas", "Resort todo incluido"],
            correctAnswer: "Villas privadas"
        }
    ]
};
