...
export const airport: ConversationScenario = {
    ...
    quiz: [
      { type: 'multiple_choice', spanish: '¿Cuánto pesa la maleta primero?', arabic: 'Wie viel wiegt der Koffer zuerst?', options: [ { text: '22 kg', correct: true }, { text: '20 kg', correct: false }, { text: '18 kg', correct: false } ] },
