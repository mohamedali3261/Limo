    ...
    <div className="space-y-8 animate-in fade-in duration-500">
      <div className="grid grid-cols-2 gap-8">
        ...
        <div className="space-y-4">
          <h3 className="text-center font-black text-gray-400 uppercase tracking-widest text-sm">English</h3>
          {leftItems.map((item) => {
            ...
            return (
              <motion.button
                ...
                className={`w-full p-4 rounded-xl border-2 font-bold text-lg transition-all flex items-center justify-between group relative ${
                  isMatched 
        ...
        {/* Arabic Column */}
        <div className="space-y-4">
          <h3 className="text-center font-black text-gray-400 uppercase tracking-widest text-sm">العربية</h3>
          {rightItems.map((item) => {
            ...
            return (
              <motion.button
                ...
                className={`w-full p-4 rounded-xl border-2 font-bold text-lg transition-all flex items-center justify-between text-right ${
                  isMatched 
                    ? 'bg-green-100 border-green-200 text-green-600 opacity-50' 
                    : isError
                      ? 'bg-red-50 border-red-500 text-red-700 animate-shake'
              ...
              >
                {item}
                {isMatched && <CheckCircle2 size={18} className="mr-2" />}
              </motion.button>
            );
          })}
        </div>
