...
export const unit9_13: CourseUnit[] = [
  {
    id: 9,
    ...
    levels: [
      ...
      { id: 37, title: 'الطبيعة', description: 'جمال الطبيعة من حولنا', type: 'lesson', color: 'bg-emerald-500', dataId: 'level17Nature', difficulty: 'advanced' },
      { id: 38, title: 'اختبار الطبيعة', description: 'تطبيق عملي', type: 'quiz', color: 'bg-yellow-500', dataId: 'level17Quiz', difficulty: 'advanced' },
    ]
  },
  {
    id: 10,
    ...
    levels: [
      ...
      { id: 41, title: 'القلعة الكبرى', description: 'تحدي المعرفة الشامل النهائي', type: 'boss', color: 'bg-red-600', dataId: 'level18Quiz', difficulty: 'advanced' },
    ]
  },
  {
    id: 11,
    ...
    levels: [
      ...
      { id: 44, title: 'المنزل', description: 'الغرف والأثاث', type: 'lesson', color: 'bg-blue-600', dataId: 'level20House', difficulty: 'advanced' },
      { id: 45, title: 'اختبار المنزل', description: 'تطبيق عملي', type: 'quiz', color: 'bg-yellow-500', dataId: 'level20Quiz', difficulty: 'advanced' },
    ]
  },
  {
    id: 12,
    ...
    levels: [
      ...
      { id: 48, title: 'التسوق', description: 'في المركز التجاري', type: 'lesson', color: 'bg-purple-600', dataId: 'level22Shopping', difficulty: 'advanced' },
      { id: 49, title: 'اختبار التسوق', description: 'تطبيق عملي', type: 'quiz', color: 'bg-yellow-500', dataId: 'level22Quiz', difficulty: 'advanced' },
    ]
  },
  {
    id: 13,
