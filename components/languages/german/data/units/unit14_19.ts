...
export const unit14_19: CourseUnit[] = [
  {
    id: 14,
    ...
    levels: [
      ...
      { id: 54, title: 'السفر والفندق', description: 'مصطلحات السياحة والإقامة', type: 'lesson', color: 'bg-red-500', dataId: 'level25Travel', difficulty: 'advanced' },
      { id: 55, title: 'اختبار السفر', description: 'تطبيق عملي', type: 'quiz', color: 'bg-yellow-500', dataId: 'level25Quiz', difficulty: 'advanced' },
    ]
  },
  {
    id: 15,
    ...
    levels: [
      ...
      { id: 58, title: 'أعضاء الجسم 2', description: 'الوجه والحواس', type: 'lesson', color: 'bg-teal-500', dataId: 'level27Body2', difficulty: 'advanced' },
      { id: 59, title: 'اختبار الجسم', description: 'تطبيق عملي', type: 'quiz', color: 'bg-yellow-500', dataId: 'level27Quiz', difficulty: 'advanced' },
    ]
  },
  {
    id: 16,
  ...
  },
  {
    ...
    levels: [
      ...
      { id: 64, title: 'الإعلام والتواصل', description: 'الصحف والأفلام', type: 'lesson', color: 'bg-orange-600', dataId: 'level30Media', difficulty: 'advanced' },
      { id: 65, title: 'اختبار الإعلام', description: 'تطبيق عملي', type: 'quiz', color: 'bg-yellow-500', dataId: 'level30Quiz', difficulty: 'advanced' },
    ]
  },
  {
    id: 18,
    ...
    levels: [
      ...
      { id: 68, title: 'المشاعر المتقدمة', description: 'الاعتزاز والأمل', type: 'lesson', color: 'bg-pink-600', dataId: 'level32Emotions', difficulty: 'advanced' },
      { id: 69, title: 'اختبار المشاعر', description: 'تطبيق عملي', type: 'quiz', color: 'bg-yellow-500', dataId: 'level32Quiz', difficulty: 'advanced' },
    ]
  },
  {
    id: 19,
    ...
    levels: [
      ...
      { id: 72, title: 'القلعة الأسطورية النهائية', description: 'تحدي المعرفة لكل المستويات', type: 'boss', color: 'bg-yellow-600', dataId: 'level33Quiz', difficulty: 'advanced' },
    ]
  }
];
