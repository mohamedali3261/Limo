...
export const hotelConversation: Conversation = {
  ...
  dialog: [
    ...
    { id: 5, speaker: 'Rezeption', speakerId: 1, german: 'Ah ja, ich habe es gefunden. Bitte füllen Sie dieses Formular aus.', arabicTranslation: 'آه نعم، لقد وجدته. يرجى ملئ هذا النموذج.', arabicPronunciation: 'آه يا، إيش هابه إس جيفوندِن. بيته فُولِن زي ديزيس فورمولار أوس.' },
