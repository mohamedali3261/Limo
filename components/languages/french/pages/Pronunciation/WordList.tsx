...
const conversations: Conversation[] = [
  { 
    ...
    dialogues: [
      ...
      { id: 3, speaker: 'A', fr: 'Je m\'appelle Sara. Et toi ?', ar: 'اسمي سارة. وأنت؟', phonetic: 'جو مابيل علي. إي توا؟' },
      { id: 4, speaker: 'B', fr: 'Moi, c\'est Ali. Enchantée !', ar: 'أنا علي. تشرفنا!', phonetic: 'موا، سي سارة. أونشانتيه!' },
