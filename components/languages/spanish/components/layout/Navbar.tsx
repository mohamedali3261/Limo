...
export function Navbar() {
  ...
  const links = [
    { to: '/spanish/lessons', label: 'المسار', icon: Map },
    { to: '/spanish/review', label: 'البطاقات', icon: BrainCircuit },
    { to: '/spanish/scenarios', label: 'النصوص', icon: MessageCircle },
    { to: '/spanish/conversations', label: 'محادثات', icon: Ear },
  ];
