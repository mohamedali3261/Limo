  ...
  return (
    <div className="h-16 bg-white border-b-2 border-stone-200 px-6 flex items-center justify-between sticky top-0 z-40 bg-white/80 backdrop-blur-md">
       ...
       <div className="flex gap-4">
          ...
          <Link to="/achievements" className="flex items-center gap-2 font-bold text-stone-500 hover:text-stone-700 bg-stone-100 px-3 py-1.5 rounded-xl hover:bg-stone-200 transition-colors">
